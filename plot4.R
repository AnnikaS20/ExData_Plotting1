...
with(timespan, {
  plot(Global_active_power~List_DateAndTime_Converted, type="l", ylab="Global Active Power (kilowatts)", xlab="")
  plot(Voltage~List_DateAndTime_Converted, type="l", ylab="Voltage (volt)", xlab="")
  plot(Sub_metering_1~List_DateAndTime_Converted, type="l", ylab="Global Active Power (kilowatts)", xlab="")
  ...
  plot(Global_reactive_power~List_DateAndTime_Converted, type="l",ylab="Global Rective Power (kilowatts)",xlab="")
})
